...
export const stepAmount = 500000;
export const minAmount = 0;
export const maxAmount = 10000000;
export const stepTerm = 1;
export const minTerm = 0;
